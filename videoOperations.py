...
def read_images(folder):
    ...
    :return:distinct_frames : a list containing tuples of the form (time_stamp, frame)
...
def edge_from_specific_pt(i_init, j_init, frames1, frames2):
    ...
    :param i_init: index of the frame in frames1 list , which matches with the
    corresponding frame in frame2 list
    :param j_init: index of the frame in frames2 list , which matches with the
    ...
    :return: status, i_last_matched, j_last_matched
